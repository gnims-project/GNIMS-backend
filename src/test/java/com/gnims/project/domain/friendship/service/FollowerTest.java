...
//        MockMultipartFile jsonFile = new MockMultipartFile("data", "", "application/json", "{\"nickname\" : \"딸기\",\"username\": \"이땡땡\", \"email\": \"ddalgi@gmail.com\", \"password\": \"123456aA9\", \"socialCode\" : \"AUTH\"}".getBytes());
...
////                .content("{\"nickname\" : \"당근\",\"username\": \"김땡땡\", \"email\": \"danguen@gmail.com\", \"password\": \"123456aA9\"}"));
//
////        mvc.perform(post("/auth/signup")
////                .contentType(MediaType.MULTIPART_FORM_DATA)
////                .content("{\"nickname\" : \"수박\",\"username\": \"박땡땡\", \"email\": \"suback@gmail.com\", \"password\": \"123456aA9\"}"));
////        mvc.perform(multipart("/auth/signup")
////                        .contentType(MediaType.APPLICATION_JSON)
////                .param("data","{\"nickname\" : \"수박\",\"username\": \"박땡땡\", \"email\": \"suback@gmail.com\", \"password\": \"123456aA9\", \"socialCode\" : \"AUTH\"}"));
//
////        mvc.perform(post("/auth/signup")
////                .contentType(MediaType.MULTIPART_FORM_DATA)
////                .content("{\"nickname\" : \"참외\",\"username\": \"최땡땡\", \"email\": \"chamwhe@gmail.com\", \"password\": \"123456aA9\"}"));
//
