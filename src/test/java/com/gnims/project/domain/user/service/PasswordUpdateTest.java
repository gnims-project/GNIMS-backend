...
public class PasswordUpdateTest {
    ...
    @DisplayName("비밀번호 정규식 불일치 실패 - 상태코드 400, 실패 메세지를 반환, db에 안 반영")
    @Test
    ...
    @DisplayName("비밀번호 기존과 일치 실패 - 상태코드 400, 실패 메세지를 반환, db에 안 반영")
    @Test
    ...
    @DisplayName("현재 비밀번호 불일치 - 상태코드 400, 실패 메세지를 반환, db에 안 반영")
    @Test
