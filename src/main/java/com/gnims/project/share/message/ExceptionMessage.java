...
public class ExceptionMessage {
    ...
    public static final String THE_SAME_SECRET_AS_BEFORE = "기존의 비밀번호와 같은 비밀번호 입니다.";
    public static final String CURRENT_MISMATCHED_SECRET = "현재 비밀번호가 일치하지 않습니다.";
    ...
    public static final String SECRET_ERROR_MESSAGE = "비밀번호는 영문/숫자를 포함하여 8~16자로 입력해야합니다.";
    ...
    public static final String SECRET_EMPTY_MESSAGE = "비밀번호는 필수 입력 값입니다.";
    public static final String OLD_SECRET_EMPTY_MESSAGE = "현재 비밀번호는 필수 입력 값입니다.";
    public static final String NEW_SECRET_EMPTY_MESSAGE = "새 비밀번호는 필수 입력 값입니다.";
    ...
    public static final String BAD_ACCESS = "잘못된 접근입니다.";
